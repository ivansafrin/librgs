...
#define DISABLE_CORRGSRectION 0
...
static void corRGSRect_errors( snes_ntsc_rgb_t color, snes_ntsc_rgb_t* out );

#if DISABLE_CORRGSRectION
	#define CORRGSRect_ERROR( a ) { out [i] += rgb_bias; }
	#define DISTRIBUTE_ERROR( a, b, c ) { out [i] += rgb_bias; }
#else
	#define CORRGSRect_ERROR( a ) { out [a] += error; }
